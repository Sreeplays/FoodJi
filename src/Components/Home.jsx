  ...
  return (
    <div className=' pt-14 '>
      <div className='max-w-[850px] mt-[-96px] w-full h-screen mx-auto text-center flex flex-col justify-center'>
        <h1 className='sm:text-5xl text-4xl md:py-6 font-sans font-extrabold hover:tracking-widest duration-700 pb-4 pt-16 mt-0 relative'><Typed strings={['F o o d J i ! ! !']} typeSpeed={60}/></h1>
